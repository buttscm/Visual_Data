class Line {
  ...
  initVis() {
    ...
    // vis.yValue_2 = d => d.Percentile90_AQI;
    // vis.yValue_3 = d => d.Median_AQI;
    ...
    vis.yScale = d3.scaleLinear()
        ...
        // vis.yScale_2 = d3.scaleLinear()
        // .domain( d3.extent(vis.data, vis.yValue_2) )
        // .range([vis.height, 0])
        // .nice(); 

        // vis.yScale_3 = d3.scaleLinear()
        // .domain( d3.extent(vis.data, vis.yValue_3) )
        // .range([vis.height, 0])
        // .nice();
